...
int solution(vector<int> arrayA, vector<int> arrayB) {
	...
	int GCD_A = GetGCDInContainer(arrayA);
	int GCD_B = GetGCDInContainer(arrayB);
...
int main()
{
	...
	{
		auto [arrA, arrB, expectedResult] = testCase;

		TestFunction(solution, make_tuple(arrA, arrB), expectedResult);
	}
